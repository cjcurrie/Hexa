...
public class ZoneRenderer : MonoBehaviour {
  ...
  // This method creates a list of 
	public static GameObject RenderZone(Zone zone, GameObject boardPrefab, TileSet tileSet)
  {
    List<GameObject> output = new List<GameObject>();

    // Determine how many meshes to chunk this zone into
    int maxWidth = 55;
    int sectionsWide = 1;
    ...
    GameObject parent = new GameObject(zone.name);
    foreach (GameObject render in output)
      render.transform.parent = parent.transform;
